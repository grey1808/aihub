...
class LoginRequest extends FormRequest
{
    ...
    {
        // Не 'email': администратор входит по логину admin, а не по почте.
        // Сотрудники при этом спокойно логинятся своей почтой — ниже
        // подбирается подходящее поле автоматически.
        return [
